...
namespace WebForms3.Logic
{
    public class NVPAPICaller
    {
        ...
        public string APIUsername = "ivanginov7-facilitator_api1.gmail.com";
        private string APIPassword = "DZ5UEY4ESXZJUYWR";
        private string APISignature = "Ao07E6U1X7hkuHOSt4GUbA-AzeVMAw0orDSjCEk765097rsNMBUBMn2w";
        ...
        public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
        {
            ...
            string returnURL = "https://localhost:44335/Checkout/CheckoutReview.aspx";
            string cancelURL = "https://localhost:44335/Checkout/CheckoutCancel.aspx";

            NVPCodec encoder = new NVPCodec();
            encoder["METHOD"] = "SetExpressCheckout";
            encoder["RETURNURL"] = returnURL;
            encoder["CANCELURL"] = cancelURL;
            encoder["BRANDNAME"] = "WebForms3";
